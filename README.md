...
## 🎓 Overview  
A collection of certifications and achievements that highlight my learning journey, technical skills, and active participation in tech communities.  

---

## 🏅 Certifications  

| Certification | Issuing Authority | Type | Date |
|---------------|------------------|------|------|
...
## 🌟 Highlights  
- Hands‑on experience through **AWS internship coursework**.  
- Active participation in **hackathons**, showcasing teamwork and innovation.  
- Verified coding skills via **HackerRank certification**.  
- Engagement in **tech quizzes and events**, reflecting curiosity and continuous learning.  

---

## ✨ Badge Wall  
Add badges/logos here for a visual impact:  

![AWS](https://img.shields.io/badge/AWS-Certified-orange)  
![Hackathon](https://img.shields.io/badge/Hackathon-Participant-green)  
![HackerRank](https://img.shields.io/badge/HackerRank-Certified-blue)  
![Quiz](https://img.shields.io/badge/Quiz-Participant-lightgrey)  
